    ...
    <section class="sidebar" style="height: auto;">
      ...
      <!-- sidebar menu: : style can be found in sidebar.less -->
        <ul class="sidebar-menu">
            ...
            <li><a href="#"><i class='fa fa-university'></i> <span>Pronvinces</span></a></li>
            <li><a href="#"><i class='fa fa-legal'></i> <span>Barangays</span></a></li>
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu" style="display: none;">
                    <li class=""><a href="../../pages/maps/populations.php"><i class="fa fa-circle-o"></i> Population</a></li>
                    <li><a href="../../pages/maps/floodmaps.php"><i class="fa fa-circle-o"></i> Flood Maps</a></li>
                </ul>
            </li>
