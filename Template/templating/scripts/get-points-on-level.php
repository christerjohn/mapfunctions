...
if(!empty($_POST["barangay_id"]) && !empty($_POST["return_period"]) && !empty($_POST["flood_level"])) {
	$query ="SELECT DISTINCT households.purok_id as purok_id, households.id as h_id, latitude as lat, longitude as lon, households.name as h_name, households.household_usage as h_usage, households.structure as h_structure
